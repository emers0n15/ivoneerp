...
$s = "SELECT artigo FROM artigos_devolvidos_temp WHERE id = '$id'";
$r = mysqli_query($db, $s);
...
$sql = "UPDATE artigos_devolvidos_temp SET qtd = '$novoValor', total = qtd*preco, iva = (total*'$ivas') WHERE id = '$id'";
