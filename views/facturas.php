                    ...
                    <table id="example" style="height: 86%;width: 100%;">
                        ...
                        <tbody>
                            ...
                            $sql = "
                                ...
                                FROM produto as p
                                LEFT JOIN stock as s ON s.produto_id = p.idproduto 
                                    AND s.prazo = (
                                        SELECT MIN(s2.prazo)
                                        FROM stock as s2
    ...
    <script>
        $(function(){
            ...
            function handleClick() {
                ...
                $.ajax({
                    type: "POST",
                    url: "fas/addarttemp.php", // Especifique o arquivo PHP desejado
                ...
                if (confirm("Tem certeza de que deseja efetuar o pagamento?")) {
                    ...
                    if(cliente == ""){
                       ...
                       //alert(cliente+":cliente modo:"+modo+" valor:"+valor+" mesa:"+mesa);
                        $.ajax({
                            type: "POST",
                            url: "fas/criarpedido.php", // Especifique o arquivo PHP desejado
                            data: {
                              cliente: cliente,
                              utente: $(".utente").val(),
                              prazo: $(".prazo").val(),
                            ...
                            success: function(data){
                                if (data == 1) {
                                  alert("Informe o cliente por favor!");
                                }else if(data == 2){
                                  ...
                                  window.open("fa_pdf.php?id_fatura="+data+"");
                                  location.reload();
                                }
                            },
                            error: function(){
            ...
            $("#cancelar").click(function() {
              if (confirm("Tem certeza de que deseja remover estes items?")){
                $.ajax({
                        url: 'fas/artremoveall.php', // Seu arquivo PHP para remover o item
                        method: 'POST',
                        success: function(response) {
                            popprodtable();
                            showtot();
            ...
            function btnremover(idProduto){
                ...
                if (confirm("Tem certeza de que deseja remover este item?")) {
                    ...
                    $.ajax({
                        url: 'fas/artremove.php', // Seu arquivo PHP para remover o item
                        method: 'POST',
