...
<html>
    <head>
      <meta charset="utf-8">
      <title>ES - Entrada de Stock</title>
                      ...
                      <div class="modal-dialog modal-md">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h3 class="modal-title fs-5" id="exampleModalLabel">Detalhes da Entrada de Stock</h3>
                          ...
                          <div class="modal-body">
                            ...
                            <div class="row">
                            <div class="col-sm-12">
                              <label class="form-label">Lote dos artigos</label><br>
                            <input type="text" name="s" class="form-control lote">
                            </div>
                            </div>
                            <div class="row">
                            <div class="col-sm-12">
                              <label class="form-label">Prazo de Validade</label><br>
                            <input type="date" name="s" class="form-control prazo">
                            </div>
                            </div>
                            <div class="row">
                            <div class="col-sm-12">
                              <label class="form-label">Familia dos artigos</label><br>
                            <select class="form-select js-example-basic-single  familia" aria-label="Default select example" id="selec" style="width: 100%;">
                                <?php 
                                  $sql = "SELECT * FROM familia_artigos ORDER BY id DESC";
                            ...
                            <div class="row">
                            <div class="col-sm-12">
                              <label class="form-label">Grupo dos artigos</label>
                            <select class="form-select js-example-basic-single1  grupo" aria-label="Default select example" id="select" style="width: 100%;">
                                <?php 
                                  $sql = "SELECT * FROM grupo_artigos ORDER BY id DESC";
                                  $rs = mysqli_query($db, $sql);
                                  while ($dados = mysqli_fetch_array($rs)) {
                                ?>
                                  <option value="<?php echo $dados['id']; ?>"><?php echo $dados['descricao']; ?></option>
                          ...
                          <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-primary btn_criar">Finalizar</button>
                          </div>
                        </div>
                      </div>
              </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-8 segunda1 table-responsive" style="background:#fff;display: flex;flex-direction: row;overflow: auto;height:90vh;color: #333;justify-content: center;padding-top: 1%;">
                    <table id="example" style="height: 86%;width: 100%;">
                      ...
                      <tbody>
                        <?php
                  $sql = "SELECT *, (SELECT descricao FROM grupo_artigos as g WHERE g.id = p.grupo) as g FROM produto as p";
                  $rs = mysqli_query($db, $sql);
                  while ($dados = mysqli_fetch_array($rs)) {
              ?>
                  <tr data-idproduto="<?php echo $dados['idproduto']; ?>">
                      <td><?php echo $dados['idproduto'] ?></td>
                      <td><?php echo $dados['g'] ?></td>
    ...
    <script>
        $(function(){
            ...
            $("#qrcode").on('change', function(){
                ...
                $.ajax({
                    type: "POST",
                    url: "estk/addarttempbarcode.php", // Especifique o arquivo PHP desejado
            ...
            function handleClick() {
                ...
                $.ajax({
                    type: "POST",
                    url: "estk/addarttemp.php", // Especifique o arquivo PHP desejado
                ...
                if (confirm("Tem certeza de que deseja efetuar o pagamento?")) {
                    ...
                    if(grupo == "" || lote == "" || prazo == ""){
                       ...
                       //alert(cliente+":cliente modo:"+modo+" valor:"+valor+" mesa:"+mesa);
                        $.ajax({
                            type: "POST",
                            url: "estk/criarestock.php", // Especifique o arquivo PHP desejado
                            data: {
                              familia: $(".familia").val(),
                              grupo: $(".grupo").val(),
                              lote: $(".lote").val(),
                            ...
                            success: function(data){
                                if(data == 2000000000000000000000000){
                                  ...
                                  window.open("es_pdf.php?id_es="+data+"");
                                  location.reload();
                                }
                            },
                            error: function(){
            ...
            $("#cancelar").click(function() {
              if (confirm("Tem certeza de que deseja remover estes items?")){
                $.ajax({
                        url: 'estk/artremoveall.php', // Seu arquivo PHP para remover o item
                        method: 'POST',
                        success: function(response) {
                            popprodtable();
                            qrcodefocus();
            ...
            function btnremover(idProduto){
                ...
                if (confirm("Tem certeza de que deseja remover este item?")) {
                    ...
                    $.ajax({
                        url: 'estk/artremove.php', // Seu arquivo PHP para remover o item
                        method: 'POST',
