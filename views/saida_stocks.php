                      ...
                      <div class="modal-dialog modal-md">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h3 class="modal-title fs-5" id="exampleModalLabel">Detalhes da Saida de Stock</h3>
                          ...
                          <div class="modal-body">
                            ...
                            <div class="row">
                            <div class="col-sm-12">
                              <label class="form-label">À Solicitar</label>
                            <input type="text" class="form-control utente" id="utente" placeholder="Obrigatorio">
                            </div>
                            </div>
                            <br>
                            <div class="row">
                            ...
                            <input type="text" class="form-control motivo" id="utente" placeholder="Opcional">
                            </div>
                            </div>
                          </div>
    ...
    <script>
        $(function(){
            ...
            $("#qrcode").on('change', function(){
                ...
                $.ajax({
                    type: "POST",
                    url: "sstk/addarttempbarcode.php", // Especifique o arquivo PHP desejado
            ...
            function handleClick() {
                ...
                $.ajax({
                    type: "POST",
                    url: "sstk/addarttemp.php", // Especifique o arquivo PHP desejado
            ...
            function criarcotacao() {
                if (confirm("Tem certeza de que deseja efetuar o pagamento?")) {
                    ...
                    if(utente == ""){
                        alert("Informe algum utente!");
                    }else{
                       //alert(cliente+":cliente modo:"+modo+" valor:"+valor+" mesa:"+mesa);
                        $.ajax({
                            type: "POST",
                            url: "sstk/criarsstock.php", // Especifique o arquivo PHP desejado
                            data: {
                              utente: $(".utente").val(),
                              motivo: $(".motivo").val()
                            },
                            success: function(data){
                                if(data == 2000000000000000000000000){
                                  ...
                                  window.open("ss_pdf.php?id_ss="+data+"");
                                  location.reload();
                                }
                            },
                            error: function(){
            ...
            $("#cancelar").click(function() {
              if (confirm("Tem certeza de que deseja remover estes items?")){
                $.ajax({
                        url: 'sstk/artremoveall.php', // Seu arquivo PHP para remover o item
                        method: 'POST',
                        success: function(response) {
                            popprodtable();
                            qrcodefocus();
            ...
            function btnremover(idProduto){
                ...
                if (confirm("Tem certeza de que deseja remover este item?")) {
                    ...
                    $.ajax({
                        url: 'sstk/artremove.php', // Seu arquivo PHP para remover o item
                        method: 'POST',
