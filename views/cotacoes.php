                      ...
                      <div class="modal-dialog modal-md">
                        ...
                        ?>
                          ...
                          <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-primary btn_criar">Efetuar Cotacao</button>
                          </div>
                        </div>
                      </div>
              </div>
    ...
    <script>
        $(function(){
            ...
            $("#qrcode").on('change', function(){
                ...
                $.ajax({
                    type: "POST",
                    url: "cts/addarttempbarcode.php", // Especifique o arquivo PHP desejado
            ...
            function handleClick() {
                ...
                $.ajax({
                    type: "POST",
                    url: "cts/addarttemp.php", // Especifique o arquivo PHP desejado
                ...
                if (confirm("Tem certeza de que deseja efetuar o pagamento?")) {
                    ...
                    if(cliente == ""){
                       ...
                       //alert(cliente+":cliente modo:"+modo+" valor:"+valor+" mesa:"+mesa);
                        $.ajax({
                            type: "POST",
                            url: "cts/criarcotacao.php", // Especifique o arquivo PHP desejado
                            data: {
                              cliente: cliente,
                              prazo: $(".prazo").val()
                            },
                            success: function(data){
                                if(data == 2000000000000000000000000){
                                  ...
                                  window.open("ct_pdf.php?id_ct="+data+"");
                                  location.reload();
                                }
                            },
                            error: function(){
            ...
            $("#cancelar").click(function() {
              if (confirm("Tem certeza de que deseja remover estes items?")){
                $.ajax({
                        url: 'cts/artremoveall.php', // Seu arquivo PHP para remover o item
                        method: 'POST',
                        success: function(response) {
                            popprodtable();
                            showtot();
            ...
            function btnremover(idProduto){
                ...
                if (confirm("Tem certeza de que deseja remover este item?")) {
                    ...
                    $.ajax({
                        url: 'cts/artremove.php', // Seu arquivo PHP para remover o item
                        method: 'POST',
