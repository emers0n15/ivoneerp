...
<html>
    <head>
      <meta charset="utf-8">
      <title>RE - Requisicao Externa</title>
                      ...
                      <div class="modal-dialog modal-md">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h3 class="modal-title fs-5" id="exampleModalLabel">Detalhes da Requisicao</h3>
                          ...
                          <div class="modal-body">
                            ...
                            <select class="form-select js-example-basic-single  fornecedor" aria-label="Default select example" id="selec" style="width: 100%;">
                                <?php 
                        ...
                        ?>
                            ...
                            <select class="form-select js-example-basic-single1  sector" aria-label="Default select example" id="select" style="width: 100%;">
                                <?php 
                        ...
                        ?>
                            ...
                            <div class="row">
                            <div class="col-sm-12">
                              <label class="form-label">À Requisitar</label>
                              <input type="text" class="form-control utente" id="utente">
                            </div>
                            </div>
                            <br>
                            <div class="row">
                            ...
                            <input type="text" class="form-control motivo" id="motivo">
                          </div>
                        </div>
                          </div>
    ...
    <script>
        $(function(){
            ...
            $("#qrcode").on('change', function(){
                ...
                $.ajax({
                    type: "POST",
                    url: "res/addarttempbarcode.php", // Especifique o arquivo PHP desejado
            ...
            function handleClick() {
                ...
                $.ajax({
                    type: "POST",
                    url: "res/addarttemp.php", // Especifique o arquivo PHP desejado
            ...
            function criarcotacao() {
                if (confirm("Tem certeza de que deseja efetuar o pagamento?")) {
                    ...
                    if(sector == ""){
                        alert("Informe algum sector!");
                    }else{
                       //alert(cliente+":cliente modo:"+modo+" valor:"+valor+" mesa:"+mesa);
                        $.ajax({
                            type: "POST",
                            url: "res/criarrqexterna.php", // Especifique o arquivo PHP desejado
                            data: {
                              sector: sector,
                              utente: $(".utente").val(),
                              motivo: $(".motivo").val(),
                            ...
                            success: function(data){
                                if(data == 2000000000000000000000000){
                                  ...
                                  window.open("re_pdf.php?id_re="+data+"");
                                  location.reload();
                                }
                            },
                            error: function(){
            ...
            $("#cancelar").click(function() {
              if (confirm("Tem certeza de que deseja remover estes items?")){
                $.ajax({
                        url: 'res/artremoveall.php', // Seu arquivo PHP para remover o item
                        method: 'POST',
                        success: function(response) {
                            popprodtable();
                            qrcodefocus();
            ...
            function btnremover(idProduto){
                ...
                if (confirm("Tem certeza de que deseja remover este item?")) {
                    ...
                    $.ajax({
                        url: 'res/artremove.php', // Seu arquivo PHP para remover o item
                        method: 'POST',
