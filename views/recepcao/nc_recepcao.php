...
<html>
    <head>
      <meta charset="utf-8">
      <title>NC - Nota de Crédito (Recepção)</title>
                      ...
                      <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h3 class="modal-title fs-5" id="exampleModalLabel">Criar Nota de Crédito</h3>
                          ...
                          <div class="modal-body">
                            ...
                            <h4>Valor da Nota de Crédito</h4>
                            <h1 class="ttl"></h1>
                            </div>
                            <br>
                            <div class="row">
                            <div class="col-sm-12">
                              ...
                              <textarea class="form-control motivo" id="motivo" rows="3" placeholder="Informe o motivo da nota de crédito..." required></textarea>
                            </div>
                            </div>
                          ...
                          <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-primary btn_criar">Criar Nota de Crédito</button>
                          </div>
                        </div>
                      </div>
              </div>
    ...
    <script>
        ...
        $(function(){
            ...
            function nrpedido(){
              $.ajax({
                  url: 'nc_recepcao/nrpedido.php',
                  type: 'GET',
                  success: function(data) {
                    $("#nrpedido").html(data);
                  },
                  error: function() {
                    $("#nrpedido").html("Erro ao carregar número da NC!");
                  }
              });
            }
      
            function popprodtable(){
                var url = 'nc_recepcao/popprodtable.php';
            ...
            function decreaseQuantity(idServico) {
                $.ajax({
                    url: 'nc_recepcao/qtd_decrease.php',
                    type: 'POST',
                    data: { id: idServico },
                    success: function(data){
                        popprodtable();
            ...
            function increaseQuantity(idServico) {
                $.ajax({
                    url: 'nc_recepcao/qtd_increase.php',
                    type: 'POST',
                    data: { id: idServico },
                    success: function(data){
                        popprodtable();
            ...
            function updateQuantity(idServico, novoValor) {
                $.ajax({
                    url: 'nc_recepcao/qtd_update.php',
                    type: 'POST',
            ...
            function showtot() {
                var url = 'nc_recepcao/show_tot.php';
                if(empresaSelecionada) {
                    url += '?empresa=' + empresaSelecionada;
                }
                $.ajax({
            ...
            $(document).on('click', '#example tbody tr', function() {
                ...
                $.ajax({
                    type: "POST",
                    url: "nc_recepcao/addservtemp.php",
                    data: { 
                        idServico: idServico,
            ...
            function criarnota() {
                ...
                if(!motivo || motivo.trim() == "") {
                    alert("Por favor, informe o motivo da nota de crédito!");
                    $(".motivo").focus();
                    return;
                }
                
                if (confirm("Tem certeza de que deseja criar a nota de crédito?")) {
                    $.ajax({
                        type: "POST",
                        url: "nc_recepcao/criarnota.php",
                        data: {
                          fatura_id: faturaSelecionada,
                          empresa_id: empresaSelecionada,
                          motivo: motivo
                        ...
                        success: function(data){
                            if (data == 1) {
                              ...
                              alert('Não é possível criar uma nota de crédito para um ano diferente do atual!');
                            }else if(data == 4){
                              ...
                              alert('Nota de crédito criada com sucesso! ID: ' + data);
                              location.reload();
                            }
                        },
                        error: function(){
            ...
            $("#cancelar").click(function() {
              if (confirm("Tem certeza de que deseja remover estes items?")){
                $.ajax({
                        url: 'nc_recepcao/removeservall.php',
                        method: 'POST',
                        success: function(response) {
                            popprodtable();
                            showtot();
            ...
            function btnremover(idServico){
                if (confirm("Tem certeza de que deseja remover este item?")) {
                    $.ajax({
                        url: 'nc_recepcao/removeservtemp.php',
                        method: 'POST',
