...
$sql = "UPDATE filadeespera SET qtdfiladeespera = '$novoValor', totalfiladeespera = qtdfiladeespera*precofiladeespera, iva = (totalfiladeespera*'$ivas') WHERE idfiladeespera = '$id'";
