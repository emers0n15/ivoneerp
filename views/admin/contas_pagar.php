                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control data1" id="data1">
                                            ...
                                            <?php 
                                                $sql = "SELECT data FROM ordem_compra;";
    ...
    <script type="text/javascript">
        $(function() {
            ...
            $("#processar").on('click', function() {
                ...
                $.ajax({
                    url: 'carregarContasPagarTotais.php',
                    type: 'GET',
                    data:{
                        data1: $("#data1").val(),
                        data2: $("#data2").val()
            ...
            $("#printa4").on('click', function() {
                var data1 = $("#data1").val();
                var data2 = $("#data2").val();
                window.open("printContasPagar.php?&data1="+data1+"&data2="+data2+"", target="_blank");
            });
            $('.utilizador').select2();
            $('.serie').select2();
            $('.data1').select2();
