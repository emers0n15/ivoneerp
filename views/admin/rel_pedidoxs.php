            ...
            $('#example').DataTable({
                ...
                "ajax": {
                    ...
                    "dataSrc": function (json) {
                        console.log(json);  // Verifique os dados retornados aqui
                        return json.data;   // A chave 'data' contém os dados que você deseja exibir
                    }, // Indica que os dados estão dentro da chave "data"
                    "error": function(xhr, error, thrown) {
                        console.log("Erro ao carregar dados: ", error);
                        console.log("Detalhes do erro: ", xhr);
                    }
                },
                "columns": [
                    { "data": "idpedido" },
