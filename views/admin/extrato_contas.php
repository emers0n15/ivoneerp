            ...
            <div class="content">
                <div class="row">
                    <div class="col-sm-4 col-3">
                        <h4 class="page-title">Extrato de Contas</h4>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control data1" id="data1" value="<?php echo $today; ?>">
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <label>Data de Término <span class="text-danger">*</span></label>
                                        <input type="date" class="form-control data2" id="data2" value="<?php echo $today; ?>">
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="form-group">
    ...
    <script type="text/javascript">
        $(function() {
            ...
            $("#printa4").on('click', function() {
                ...
                var data1 = $("#data1").val();
                var data2 = $("#data2").val();
                window.open("printExtratoContas.php?serie="+serie+"&data1="+data1+"&data2="+data2+"", target="_blank");
            });
            $('.serie').select2();
