            ...
            <div class="content">
                <div class="row">
                    <div class="col-sm-4 col-3">
                        <h4 class="page-title">Cotações</h4>
                    </div>
                    <div class="col-sm-8 col-9 text-right m-b-20">
                        <a href="rel_cotacao.php" class="btn btn-primary btn-rounded float-right" style="margin-left: 10px;"><i class="fa fa-file"></i> Criar Relatório</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
    ...
    <script>
        $(function() {
            ...
            $('#example').on('click', '.print-action', function() {
                ...
                window.open('../ct_pdf.php?id_ct=' + data.id, '_blank');
            });
        });
    </script>
<!-- add-patient24:07-->
