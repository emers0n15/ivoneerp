            ...
            <div class="content">
                <div class="row">
                    ...
                    <div class="col-sm-8 col-9 text-right m-b-20">
                        ...
                        <a href="rel_recibos.php" class="btn btn-primary btn-rounded float-right">
...
<link href="../datatables.min.css" rel="stylesheet"/>
    ...
    var table = $('#example').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            "url": "poprc.php", // URL do script PHP que retornará os dados de recibos
            "type": "GET",
    ...
    $('#example').on('click', '.print-action', function() {
        ...
        window.open('../rc_pdf.php?id_rc=' + data.id, '_blank');
    });
});
    </script>
<!-- add-patient24:07-->
