            ...
            <div class="content">
                <div class="row">
                    <div class="col-sm-4 col-3">
                        <h4 class="page-title">Extrato de Clientes</h4>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control data1" id="data1">
                                            ...
                                            <?php 
                                                $sql = "SELECT data FROM transacoes;";
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control utilizador" id="cliente">
                    ...
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <table id="example1" class="display">
                                <thead>
                                    <tr>
                                        <th colspan="4">Tabela de Totais</th>
                                        <th>Débito</th>
                                        <th>Crédito</th>
                                        <th>Saldo</th>
                                    </tr>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            $("#processar").on('click', function() {
                $.ajax({
                    url: 'carregarExtratoClientes.php',
                    type: 'GET',
                    data:{
                        cliente: $("#cliente").val(),
                        serie: $("#serie").val(),
                    ...
                    error: function() {
                        $("#example tbody").html("<tr><td colspan='13'>Erro ao popular as entradas de stock! Contante o administrador do sistema.</td></tr>");
                    }
                });
                $.ajax({
                    url: 'carregarExtratoClientesTotais.php',
                    type: 'GET',
                    data:{
                        cliente: $("#cliente").val(),
                        serie: $("#serie").val(),
                    ...
                    error: function() {
                        $("#example1 tbody").html("<tr><td colspan='13'>Erro ao popular as entradas de stock! Contante o administrador do sistema.</td></tr>");
                    }
                });
            });
            $("#printa4").on('click', function() {
                ...
                var data1 = $("#data1").val();
                var data2 = $("#data2").val();
                window.open("printExtratoCliente.php?cliente="+cliente+"&serie="+serie+"&data1="+data1+"&data2="+data2+"", target="_blank");
            });
            $('.utilizador').select2();
            $('.serie').select2();
            $('.data1').select2();
