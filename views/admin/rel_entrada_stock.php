            ...
            <div class="content">
                <div class="row">
                    <div class="col-sm-4 col-3">
                        <h4 class="page-title">Novo Relatório de Entradas de Stock</h4>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 col-9 text-right" id="divv">
                        ...
                        <a id="printa44" class="btn btn-primary btn-rounded float-right"><i class="fa fa-print"></i> Relatorio Resumo</a>
                        <a id="printa4" class="btn btn-primary btn-rounded float-right"><i class="fa fa-print"></i> Relatorio Detalhado</a>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control data1" id="data1">
                                            ...
                                            <?php 
                                                $sql = "SELECT data FROM entrada_stock;";
                            ...
                            <table id="xample">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>Descrição</th>
                                        <th>Grupo de Artigos</th>
                                        <th>Família de Artigos</th>
                                        <th>Utilizador</th>
                                    </tr>
                                </thead>
                                <tbody>
        ...
        $(function() {
            ...
            $("#processar").on('click', function() {
                $.ajax({
                    ...
                    error: function() {
                        $("tbody").html("<tr><td colspan='13'>Erro ao popular as entradas de stock! Contante o administrador do sistema.</td></tr>");
                    }
                });
            });
            $("#printa4").on('click', function() {
                ...
                var data1 = $("#data1").val();
                var data2 = $("#data2").val();
                window.open("printEntradaStock.php?utilizador="+utilizador+"&serie="+serie+"&data1="+data1+"&data2="+data2+"", target="_blank");
            });
            $("#printa44").on('click', function() {
                var utilizador = $("#utilizador").val();
                var serie = $("#serie").val();
                var data1 = $("#data1").val();
                var data2 = $("#data2").val();
                window.open("printEntradaStocks.php?utilizador="+utilizador+"&serie="+serie+"&data1="+data1+"&data2="+data2+"", target="_blank");
            });
            $('.utilizador').select2();
            $('.serie').select2();
            $('.data1').select2();
