                    ...
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <table id="example1" class="display">
                                <thead>
                                    <tr>
                                        <th>Tabela de Totais</th>
                                        <th>Total por Receber</th>
                                    </tr>
                                </thead>
                                <tbody>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            $("#processar").on('click', function() {
                ...
                $.ajax({
                    url: 'carregarContasReceberTotais.php',
                    type: 'GET',
                    data:{
                        data1: $("#data1").val(),
                        data2: $("#data2").val()
            ...
            $("#printa4").on('click', function() {
                var data1 = $("#data1").val();
                var data2 = $("#data2").val();
                window.open("printContasReceber.php?&data1="+data1+"&data2="+data2+"", target="_blank");
            });
            $('.utilizador').select2();
            $('.serie').select2();
            $('.data1').select2();
