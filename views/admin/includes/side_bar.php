            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <li class="active">
                            <a href="index.php"><i class="fa fa-home"></i> <span>Início</span></a>
                        </li>
                        <li>
                        ...
                        ?>
                            ...
                            <li class="submenu">
                                ...
                                <ul style="display: none;">
                                    ...
                                    <li><a href="../cotacao.php" target="_blank">CT - Cotação</a></li>
                            ...
                            <li class="submenu">
                                ...
                                <ul style="display: none;">
                                    ...
                                    <li><a href="consumo_medio.php">Consumo Medio</a></li>
                                </ul>
                            </li>
                            <li class="submenu">
                        ...
                        ?>
                            ...
                            <li class="submenu">
                                ...
                                <ul style="display: none;">
                                    ...
                                    <li><a href="extrato_contas.php">Extrato de Contas</a></li>
                                    <li><a href="balancete.php">Balancete</a></li>
                                    <li><a href="relatorio_produto.php">Relatório por Produto</a></li>
                                    <!-- <li><a href="../movimentos.php" target="_blank">Movimentos</a></li> -->
                                </ul>
                            </li>
                        <?php
                        ...
                        ?>
						    ...
						    <li class="submenu">
    							...
    							<ul style="display: none;">
                                        ...
                                        <li><a href="entrada_stock.php">Entrada de Stock</a></li>
                                        <li><a href="saida_stock.php">Saída de Stock</a></li>
                                        <li><a href="armazens.php">Armazéns</a></li>

    								<li><a href="inventario.php">Inventário</a></li>
    								<li><a href="periodicidade.php">Periodicidade</a></li>
                                    <li><a href="consumo_medio.php">Consumo Medio</a></li>
                                    <li><a href="consumo_artigos_baixo.php">Artigos c/ Baixo Estoque</a></li>
    							</ul>
    						</li>
                            <li class="submenu">
                                <a href="#"><i class="fa fa-money"></i> <span> Fluxo de Caixa </span> <span class="menu-arrow"></span></a>
                        ...
                        <?php
                            }else if ($_SESSION['categoriaUsuario'] == "recepcao_mestre") {
                        ?>
                            <li class="submenu">
                                <a href="#"><i class="fa fa-coffee"></i> <span> Artigos </span> <span class="menu-arrow"></span></a>
                                <ul style="display: none;">
