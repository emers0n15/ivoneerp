            ...
            <div class="content">
                <div class="row">
                    <div class="col-sm-4 col-3">
                        <h4 class="page-title">Novo Relatório de Facturas</h4>
                    </div>
                    <div class="col-sm-8 col-9 text-right m-b-20">
                        <a href="factura.php" class="btn btn-primary btn-rounded float-right"><i class="fa fa-navicon"></i> Lista de Facturas</a>
                    </div>
                </div>
                <style type="text/css">
                    #divv{
        ...
        $(function() {
            ...
            $("#processar").on('click', function() {
                $.ajax({
                    ...
                    error: function() {
                        $("tbody").html("<tr><td colspan='13'>Erro ao popular o extrato! Contante o administrador do sistema.</td></tr>");
                    }
                });
            });
            $("#printa4").on('click', function() {
                ...
                var data1 = $("#data1").val();
                var data2 = $("#data2").val();
                window.open("printFacturas.php?serie="+serie+"&data1="+data1+"&data2="+data2+"", target="_blank");
            });
