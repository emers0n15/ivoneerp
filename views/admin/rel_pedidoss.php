            ...
            <div class="content">
                <div class="row">
                    <div class="col-sm-4 col-3">
                        <h4 class="page-title">Novo Relatório de VDS</h4>
                    </div>
                    <div class="col-sm-8 col-9 text-right m-b-20">
                        <a href="rel_pedidos.php" class="btn btn-primary btn-rounded float-right"><i class="fa fa-navicon"></i> Lista de VDS</a>
                    </div>
                </div>
                <style type="text/css">
                    #divv{
    ...
    <script type="text/javascript">
        $(function() {
            ...
            $("#printa4").on('click', function() {
                ...
                var data1 = $("#data1").val();
                var data2 = $("#data2").val();
                window.open("printVDs.php?serie="+serie+"&data1="+data1+"&data2="+data2+"", target="_blank");
            });
