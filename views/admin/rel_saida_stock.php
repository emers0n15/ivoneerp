            ...
            <div class="content">
                <div class="row">
                    <div class="col-sm-4 col-3">
                        <h4 class="page-title">Novo Relatório de Saída de Stock</h4>
                    </div>
                    <div class="col-sm-8 col-9 text-right m-b-20">
                        <a href="extrato_factura.php" class="btn btn-primary btn-rounded float-right"><i class="fa fa-navicon"></i> Lista de Saída</a>
                    </div>
                </div>
                <style type="text/css">
                    #divv{
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control data1" id="data1">
                                            ...
                                            <?php 
                                                $sql = "SELECT data FROM saida_stock;";
    ...
    <script type="text/javascript">
        $(function() {
            ...
            $("#printa4").on('click', function() {
                ...
                var data1 = $("#data1").val();
                var data2 = $("#data2").val();
                window.open("printSaidaStock.php?utilizador="+utilizador+"&serie="+serie+"&data1="+data1+"&data2="+data2+"", target="_blank");
            });
            $('.utilizador').select2();
            $('.serie').select2();
            $('.data1').select2();
