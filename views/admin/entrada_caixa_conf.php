            ...
            <div class="content">
                <div class="row">
                    <div class="col-sm-4 col-3">
                        <h4 class="page-title">Entrada de Caixa</h4>
                    </div>
                    <div class="col-sm-8 col-9 text-right m-b-20">
                        <a href="compras.php" class="btn btn-primary btn-rounded float-right"><i class="fa fa-navicon"></i> Lista de Entradas</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-8">
                        <h4 class="page-title">Nova Entrada</h4>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-12">
                        <form method="POST" action="daos/nova_entrada_caixa.php" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-sm-6">
                            ...
                            <div class="col-md-12">
                                ...
                                <button class="btn btn-primary submit-btn" type="submit" name="btn">Criar entrada</button>
                            </div>
                            </div>
