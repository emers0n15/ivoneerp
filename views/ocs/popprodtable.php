...
$sql = "SELECT *, (SELECT nomeproduto FROM produto as p WHERE p.idproduto = ps.artigo) as nome FROM ordem_compra_artigos_temp as ps WHERE user = '$userID'";
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-4" style="display:flex;flex-direction:row;justify-content:flex-end;">
                    <h4 class="card-text"><?php echo number_format($dados['total'] + $dados['iva'], 2, ',', '.'); ?></h4>
                </div>
            </div>
        </div>
